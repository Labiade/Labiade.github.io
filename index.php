...
<link rel="icon" type="image/x-icon" href="http://sk-pop.000webhostapp.com/Favicon.ico" />
<link rel="shortcut icon" type="image/ico" href="http://sk-pop.000webhostapp.com/Favicon.ico"/>
<link rel="shortcut icon" type="image/ico" href="https://sk-pop.000webhostapp.com/Favicon.ico"/>
<link rel="shortcut icon" type="image/ico" href="http://sk-pop.000webhostapp.com/Favicon.ico"/>
<link rel="shortcut icon" type="image/ico" href="https://sk-pop.000webhostapp.com/Favicon.ico"/>
<style>
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">K <span class="w3-hide-small">-</span> Zone</span>
  </div>
</div>
...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <p><b><i class="fa fa-user w3-margin-right"></i>Mister.I.</b></p><br>
      <img src="https://i.pinimg.com/originals/30/82/28/308228a16e1fc603a0ba4e6ae6069a47.jpg" class="w3-round w3-image w3-opacity w3-hover-opacity-off" alt="Photo of Me" width="500" height="333">
    </div>
  ...
  <div class="w3-row w3-padding-32 w3-section">
    ...
    <div class="w3-col m8 w3-panel">
      <div class="w3-large w3-margin-bottom">
        ...
        <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +00 XXXX15<br>
        <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: MasterNilM@Gmail.com<br>
      </div>
        ...
        <div class="form-container">
            <form action="mail.php" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input  id="user_subject" name="user_subject" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label for="user_message">Message</label>
                    <textarea  id="user_message" name="user_message" rows="6" class="form-control"></textarea>
                </div>
...
<footer class="w3-center w3-black w3-padding-64 w3-opacity w3-hover-opacity-off">
  ...
  <p>Powered by <a href="https://sk-pop.000webhostapp.com" title="W3.CSS" target="_blank" class="w3-hover-text-green">Mister.I.</a></p>
</footer>
